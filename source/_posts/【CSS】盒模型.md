...
categories:
typora-root-url: 【CSS】盒模型
typora-copy-images-to: 【CSS】盒模型
---

# 是什么
---
盒模型又称框模型（Box Model）,包含了元素内容（content）、内边距（padding）、边框（border）、外边距（margin）几个要素
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190330162953242.png)
# 目的
---
- 方便计算宽度
- 更好布局
...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190330163611690.png)、
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190330172923552.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190330165723844.png)
**分类边界**
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190330173135288.png)
...
**顺序**
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190330173751943.png)
